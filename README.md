...
- 3.2. User Stories.
	...
	|------|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|---------------------------------|
	| US001| Diseño de Interfaz de Navegación       | Crear una interfaz de usuario intuitiva y fácil de navegar, que incluya un menú de navegación con enlaces a las diferentes secciones del sitio web.                 | Completado | Epic #1 - Diseño y Usabilidad   |
