...
|---------------------|----------------------|--------------|
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Adrián Enrique Jesús Palma Obispo** <br> **TB1:** Se compartieron ideas sobre la problemática de la falta de ergonomización en los hogares y se diseñó la landing page en base a esas necesidades. Se comunicaron ideas y resultados desde un punto de vista objetivo para el desarrollo del proyecto. <br> **TP:** Se compartieron ideas sobre el desarrollo del código y funcionamiento del FrontEnd de la Web App. | **TB1:** Se reforzó la práctica en el desarrollo del landing, mock y wireframes, solicitando apoyo del equipo para generar más ideas. El intercambio de objetivos permitió sacar adelante al equipo en la elaboración del proyecto. <br> **TP:** La comunicación de las ideas para el FrontEnd de la Web App ayudó a mejorar el desarrollo de esta. |
| | **Erick Joaquín Palomino Santa Cruz** <br> **TB1:** Se comunicaron ideas sobre el enfoque de trabajo y los puntos a completar para el desarrollo del proyecto. <br> **TP:** Se comunicaron ideas sobre cómo mejorar el desarollo de la Web App. | **TB1:** El diálogo permitió elaborar con facilidad y agilidad el Sprint y el Landing Page. <br> **TP:** La comunicación oral de las ideas facilitó el desarrollo y ejecución de la Web App. |
| | **Joaquín Alonso Carbajal Pozzo** <br> **TB1:** Se comunicaron ideas sobre la lógica de negocio para el desarrollo del proyecto. <br> **TP:** Se comunicaron ideas sobre el desarrollo de los componentes de la Web App | **TB1:** La comunicación de las ideas facilitó y enriqueció el desarrollo del proyecto. <br> **TP:** La comunicación oral ayudó con la correcta sincronización del equipo. |
| | **Renzo Cesar Silva Morales** <br> **TB1:** Se comunicaron ideas sobre las necesidades que cubrirá nuestro proyecto. <br> **TP:** Se comunicaron ideas sobre el server de la Web App. | **TB1:** La comunicación del equipo ayudó a llevar el proyecto por un mejor camino. <br> **TP:** Las comunicación en grupo facilitó el desarrollo y mejoró la organización de tareas.|
...
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Adrián Enrique Jesús Palma Obispo** <br> **TB1:** Se tuvieron reuniones en Discord y Google Meet para distribuir los puntos del trabajo y comunicar dificultades al realizar los wireframes. Se logró la comunicación entre todos los integrantes para poder elaborar el producto. <br> **TP:** Se realizaron reuniones por Discord en donde se redactó y se realizó la distribución de tareas. | **TB1:** Se logró delimitar los objetivos y extensión de la Startup, basándose en el público laboral y académico. La comunicación escrita permitió hallar el objetivo grupal para el proyecto y culminarlo hasta su versión más reciente. <br> **TP:** Se logró un correcto desarrollo en grupo del FrontEnd de la WebApp gracias a la comunicación escrita. |
| | **Erick Joaquín Palomino Santa Cruz** <br> **TB1:** Se compartieron ideas y mensajes de forma escrita para la elaboración del proyecto a través de chat y Trello. <br> **TP:** Se comunicó las actualizaciones del desarrollo de la Web App mediante mensajes de WhatsApp. | **TB1:** Se definieron y elaboraron las ideas del proyecto gracias a la comunicación escrita. <br> **TP:** La comunicación escrita fue clave para mantenernos informados sobre las actualizaciones del proyecto. |
| | **Joaquín Alonso Carbajal Pozzo** <br> **TB1:** Se compartieron puntos de vista e ideas mediante mensajes de chat. <br> **TP:** Se comunicaron ideas mediante mensajes de WhatsApp. | **TB1:** La comunicación escrita permitió dejar constancia de las diversas actividades que desempeñó cada uno de los integrantes. <br> **TP:** La comunicación escrita ayudó con el orden y distribución de tareas. |
| | **Renzo Cesar Silva Morales** <br> **TB1:** Se compartieron puntos de vista mensajes de chat y Trello. <br> **TP:** Se comunicó la organización de tareas mediante el chat de Discord. | **TB1:** La comunicación escrita permitió una mejor organización de actividades entre los integrantes. <br> **TP:** La comunicación escrita permitió definir las tareas que se asignaron a los miembros del equipo. |
