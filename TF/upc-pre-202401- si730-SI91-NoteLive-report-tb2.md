...
|---------------------|----------------------|--------------|
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Adrián Enrique Jesús Palma Obispo** <br> **TB1:** Se compartieron ideas sobre la problemática de la falta de ergonomización en los hogares y se diseñó la landing page en base a esas necesidades. Se comunicaron ideas y resultados desde un punto de vista objetivo para el desarrollo del proyecto. <br> **TP:** Se compartieron ideas sobre el desarrollo del código y funcionamiento del FrontEnd de la Web App. <br> **TB2:** Comunique el desarrollo del backend y del frontend. <br> **TF:** Comunique el desarrollo del backend y del frontend. | **TB1:** Se reforzó la práctica en el desarrollo del landing, mock y wireframes, solicitando apoyo del equipo para generar más ideas. El intercambio de objetivos permitió sacar adelante al equipo en la elaboración del proyecto. <br> **TP:** La comunicación de las ideas para el FrontEnd de la Web App ayudó a mejorar el desarrollo de esta. <br> **TB2:** La comunicación del desarrollo del backend y frontend permitió asegurar la comprensión y el progreso del equipo.  <br> **TF:** La comunicación del desarrollo del backend y frontend ayudó a finalizar el proyecto con éxito y mantener la coherencia técnica. |
| | **Erick Joaquín Palomino Santa Cruz** <br> **TB1:** Se comunicaron ideas sobre el enfoque de trabajo y los puntos a completar para el desarrollo del proyecto. <br> **TP:** Se comunicaron ideas sobre cómo mejorar el desarollo de la Web App. <br> **TB2:** Se comunicó los requisitos necesarios para realizar las validation interviews a los segmentos objetivos.  <br> **TF:**  Coordinó con el equipo para realizar correcciones al proyecto, además sugirió utilizar más herramientas que ayuden al proyecto.| **TB1:** El diálogo permitió elaborar con facilidad y agilidad el Sprint y el Landing Page. <br> **TP:** La comunicación oral de las ideas facilitó el desarrollo y ejecución de la Web App.  <br> **TB2:** La comunicación de los requisitos permitió realizar entrevistas efectivas y obtener feedback valioso. <br> **TF:** La coordinación y sugerencias ayudaron a mejorar el proyecto y a utilizar herramientas más eficaces.|
| | **Joaquín Alonso Carbajal Pozzo** <br> **TB1:** Se comunicaron ideas sobre la lógica de negocio para el desarrollo del proyecto. <br> **TP:** Se comunicaron ideas sobre el desarrollo de los componentes de la Web App <br> **TB2:** Presentó el avance del informe y coordinó el despliegue del backend.  <br> **TF:** Presentó el avance del informe y coordinó el despliegue del backend.| **TB1:** La comunicación de las ideas facilitó y enriqueció el desarrollo del proyecto. <br> **TP:** La comunicación oral ayudó con la correcta sincronización del equipo. <br> **TB2:** La presentación del informe y la coordinación del despliegue aseguraron el progreso y calidad del proyecto.  <br> **TF:** La presentación continua del informe y la coordinación del despliegue garantizaron un proyecto bien estructurado y funcional.|
| | **Renzo Cesar Silva Morales** <br> **TB1:** Se comunicaron ideas sobre las necesidades que cubrirá nuestro proyecto. <br> **TP:** Se comunicaron ideas sobre el server de la Web App. <br> **TB2:** Realizó entrevistas y recopiló evidencia de la suite de pruebas. <br> **TF:** Aplicó XML documentation, JSDoc y organizó el frontend y backend. | **TB1:** La comunicación del equipo ayudó a llevar el proyecto por un mejor camino. <br> **TP:** Las comunicación en grupo facilitó el desarrollo y mejoró la organización de tareas. <br> **TB2:** La realización de entrevistas y la recolección de evidencia mejoraron la calidad y precisión del proyecto. <br> **TF:** La aplicación de documentación y organización técnica facilitó el mantenimiento y desarrollo del proyecto.|
| | **Piero Alonso Martinez Villanueva** <br> **TB1:** Se comunicó sobre las principales funcionalidades del proyecto. <br> **TP**: Se asignó el desarrollo del login-page y register-page del frontend <br> **TB2:**: Se comunicó los requisitos necesarios para realizar las validation interviews a los segmentos objetivos. <br> **TF**: Coordinó con el equipo para realizar correcciones al proyecto, además sugirió utilizar más herramientas que ayuden al proyecto. | **TB1:** La comunicación facilitó la ejecución de las ideas iniciales de proyecto. <br> **TP:** Las reuniones en grupo permitieron comprender mejor las tareas a desarrollar. <br> **TB2**: Coordinar con el equipo y los entrevistadores permitió una forma más asertiva de resolver las problemáticas del proyecto.  <br> **TF**: Entablar comunicación con el equipo de desarrolló permitió repartir responsabilidades de manera correcta, gracias a esto cada integrante logró culminar el proyecto sin dificultades. |
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Adrián Enrique Jesús Palma Obispo** <br> **TB1:** Se tuvieron reuniones en Discord y Google Meet para distribuir los puntos del trabajo y comunicar dificultades al realizar los wireframes. Se logró la comunicación entre todos los integrantes para poder elaborar el producto. <br> **TP:** Se realizaron reuniones por Discord en donde se redactó y se realizó la distribución de tareas. <br> **TB2:** Documentó el código del backend y frontend de manera detallada y clara. <br> **TF:** Redactó informes técnicos sobre el desarrollo del backend y frontend, asegurando que fueran comprensibles para diferentes audiencias. | **TB1:** Se logró delimitar los objetivos y extensión de la Startup, basándose en el público laboral y académico. La comunicación escrita permitió hallar el objetivo grupal para el proyecto y culminarlo hasta su versión más reciente. <br> **TP:** Se logró un correcto desarrollo en grupo del FrontEnd de la WebApp gracias a la comunicación escrita. <br> **TB2:** La documentación detallada del código del backend y frontend facilitó la comprensión y el mantenimiento del proyecto. <br> **TF:** Los informes técnicos redactados sobre el backend y frontend aseguraron que la información fuera clara y accesible para diversas audiencias.|
| | **Erick Joaquín Palomino Santa Cruz** <br> **TB1:** Se compartieron ideas y mensajes de forma escrita para la elaboración del proyecto a través de chat y Trello. <br> **TP:** Se comunicó las actualizaciones del desarrollo de la Web App mediante mensajes de WhatsApp. <br> **TB2:** Documentó el código del backend y frontend de manera detallada y clara.  <br> **TF:** Redactó informes técnicos sobre el desarrollo del backend y frontend, asegurando que fueran comprensibles para diferentes audiencias. | **TB1:** Se definieron y elaboraron las ideas del proyecto gracias a la comunicación escrita. <br> **TP:** La comunicación escrita fue clave para mantenernos informados sobre las actualizaciones del proyecto. <br> **TB2:** La implementación del código del backend y frontend fue crucial para el desarrollo del proyecto, asegurando la funcionalidad y estabilidad del sistema. <br> **TF:** La creación y ajuste del código del backend y frontend ayudaron a culminar el proyecto exitosamente, destacando la importancia de la integración y coherencia entre ambas partes del sistema.|
| | **Joaquín Alonso Carbajal Pozzo** <br> **TB1:** Se compartieron puntos de vista e ideas mediante mensajes de chat. <br> **TP:** Se comunicaron ideas mediante mensajes de WhatsApp. **TB2:** Redactó y corrigió el informe del proyecto, detallando los avances y resultados. <br> **TF**: Continuó mejorando y detallando el informe del proyecto, documentando el proceso de despliegue del backend. | **TB1:** La comunicación escrita permitió dejar constancia de las diversas actividades que desempeñó cada uno de los integrantes. <br> **TP:** La comunicación escrita ayudó con el orden y distribución de tareas. <br> **TB2:** La corrección y avance del informe, junto con el despliegue del backend, garantizaron que el proyecto estuviera bien documentado y operativo. <br> **TF:** Continuar con la mejora del informe y el despliegue del backend fue esencial para presentar un proyecto cohesionado y completamente funcional, resaltando la importancia de una buena documentación y despliegue técnico.|
| | **Renzo Cesar Silva Morales** <br> **TB1:** Se compartieron puntos de vista mensajes de chat y Trello. <br> **TP:** Se comunicó la organización de tareas mediante el chat de Discord. <br> **TB2:** Documentó las entrevistas y la evidencia de la suite de pruebas en informes detallados. <br> **TF:** Creó documentación técnica utilizando XML y JSDoc, y estructuró la información del frontend y backend. | **TB1:** La comunicación escrita permitió una mejor organización de actividades entre los integrantes. <br> **TP:** La comunicación escrita permitió definir las tareas que se asignaron a los miembros del equipo. <br> **TB2:** Las entrevistas y la evidencia de la suite de pruebas permitieron identificar y corregir errores, mejorando la calidad del producto final. <br> **TF:** La documentación XML y JSDoc, junto con la organización del frontend y backend, fueron fundamentales para mantener una estructura clara y entendible, facilitando el mantenimiento y futuras expansiones del proyecto.|
| | **Piero Alonso Martinez Villanueva** <br> **TB1:** Se comunico sobre las principales funcionalidades del proyecto. <br> **TP:** Se asignó el desarrollo del login-page y register-page del frontend <br> **TB2**: Escribió los requisitos necesarios para realizar correcciones generales y para coordinar las validation interviews, colaboró en la comprobación del backend  <br> **TF**: Añadió el Pivotal Tracker y el Trello de proyecto, redactó todo el PPT final del proyecto y testeo la versión final aplicación web. | **TB1:** La comunicación escrita ayudó a entender de manera más clara el proyecto. <br> **TP:** Se facilitó la comprensión de los componentes necesarios a utilizar para el desarrollo de la aplicación web <br> **TB2**: Gracias a las validation interviews, se aplicó las correcciones necesarias al proyecto y a ajustar la aplicación web a los requisitos del segmento al que va enfocado.  <br> **TF**: Manejar las actualizaciones en un informe y testear la aplicación con la opinión de los segmentos objetivos ayudó para la culminación del proyecto, gracias a este proyecto se comprendió mejor el rol de un profesional al realizar un informe acerca de su proyecto que va desarrollando. |
...
Se hizo uso de SmarterASP, un servicio público gratuito que permite desplegar tanto una base de datos como un backend.
...
<img src="images/insights-spring4-webapp.png" width="80%" align="center">

<img src="images/insights-spring4-webapp2.png" width="80%" align="center">

**Backend:**

<img src="images/insights-spring4-backend.png" width="80%" align="center">

<img src="images/insights-spring4-backend2.png" width="80%" align="center">

**Informe:**

<img src="images/insights-spring4.png" width="80%" align="center">

<img src="images/insights-spring4-2.png" width="80%" align="center">
...
### 5.3.2. Registro de Entrevistas
 ...
 - Profesores y Educadores:
   ...
   - Entrevista #1:
	...
	<img src="images/Validation_Interview_Profesores-1.png" width="100%" align="center">
   ...
   - Entrevista #2:
	...
	<img src="images/Validation_Interview_Profesores-2.png" width="100%" align="center">
