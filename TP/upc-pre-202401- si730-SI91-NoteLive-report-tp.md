...
|---------------------|----------------------|--------------|
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Adrián Enrique Jesús Palma Obispo** <br> TB1: Se compartieron ideas sobre la problemática de la falta de ergonomización en los hogares y se diseñó la landing page en base a esas necesidades. Se comunicaron ideas y resultados desde un punto de vista objetivo para el desarrollo del proyecto. | TB1: Se reforzó la práctica en el desarrollo del landing, mock y wireframes, solicitando apoyo del equipo para generar más ideas. El intercambio de objetivos permitió sacar adelante al equipo en la elaboración del proyecto. |
| | **Erick Joaquín Palomino Santa Cruz** <br> TB1: Se comunicaron ideas sobre el enfoque de trabajo y los puntos a completar para el desarrollo del proyecto. | TB1: El diálogo permitió elaborar con facilidad y agilidad el Sprint y el Landing Page. |
| | **Joaquín Alonso Carbajal Pozzo** <br> TB1: Se comunicaron ideas sobre la lógica de negocio para el desarrollo del proyecto. | TB1: La comunicación de las ideas facilitó y enriqueció el desarrollo del proyecto.|
| | **Renzo Cesar Silva Morales** <br> TB1: Se comunicaron ideas sobre las necesidades que cubrirá nuestro proyecto. <br> TP: Se comunicaron ideas sobre el desarrollo de la Web App. | TB1: La comunicación del equipo ayudó a llevar el proyecto por un mejor camino. <br> TP: Las comunicación en grupo facilitó el desarrollo y mejoró la organización de tareas.|
