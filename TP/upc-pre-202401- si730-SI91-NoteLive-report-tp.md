...
|---------------------|----------------------|--------------|
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Adrián Enrique Jesús Palma Obispo** <br> **TB1:** Se compartieron ideas sobre la problemática de la falta de ergonomización en los hogares y se diseñó la landing page en base a esas necesidades. Se comunicaron ideas y resultados desde un punto de vista objetivo para el desarrollo del proyecto. <br> **TP:** Se comunicaron ideas sobre el desarrollo de la Web App. | **TB1:** Se reforzó la práctica en el desarrollo del landing, mock y wireframes, solicitando apoyo del equipo para generar más ideas. El intercambio de objetivos permitió sacar adelante al equipo en la elaboración del proyecto. <br> **TP:** La comunicación de las ideas para la Web App ayudó a mejorar el desarrollo de esta. |
...
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Adrián Enrique Jesús Palma Obispo** <br> TB1: Se tuvieron reuniones en Discord y Google Meet para distribuir los puntos del trabajo y comunicar dificultades al realizar los wireframes. Se logró la comunicación entre todos los integrantes para poder elaborar el producto. | TB1: Se logró delimitar los objetivos y extensión de la Startup, basándose en el público laboral y académico. La comunicación escrita permitió hallar el objetivo grupal para el proyecto y culminarlo hasta su versión más reciente. |
| | **Erick Joaquín Palomino Santa Cruz** <br> TB1: Se compartieron ideas y mensajes de forma escrita para la elaboración del proyecto a través de chat y Trello. | TB1: Se definieron y elaboraron las ideas del proyecto gracias a la comunicación escrita. |
| | **Joaquín Alonso Carbajal Pozzo** <br> TB1: Se compartieron puntos de vista e ideas mediante mensajes de chat. | TB1: La comunicación escrita permitió dejar constancia de las diversas actividades que desempeñó cada uno de los integrantes. |
